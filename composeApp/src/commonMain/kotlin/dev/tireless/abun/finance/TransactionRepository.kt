...
class TransactionRepository(
     ...
     */
    suspend fun getTagsForTransaction(transactionId: Long): List<FinanceTag> =
        withContext(Dispatchers.IO) {
     ...
     */
    suspend fun getTransactionsByTag(tagId: Long): List<Transaction> =
        withContext(Dispatchers.IO) {
    ...
    private fun dev.tireless.abun.database.FinanceTag.toDomainTag() =
        FinanceTag(
            id = id,
            name = name,
            colorHex = color_hex,
